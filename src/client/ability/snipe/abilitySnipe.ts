...
export function getOptionsSnipeUpgrade(ability: Ability, upgradeName: string): UpgradeOptionAndProbability[] {
    ...
    options[0].option.displayMoreInfoText = upgradeFunctions.getMoreInfoIncreaseOneLevelText!(ability, options[0].option as AbilityUpgradeOption);
    ...
    if (upgrade && !upgrade.upgradeSynergy) {
        if (upgradeFunctions.addSynergyUpgradeOption && upgradeFunctions.addSynergyUpgradeOption(ability)) {
            ...
            options[1].option.displayMoreInfoText = upgradeFunctions.getMoreInfoIncreaseOneLevelText!(ability, options[1].option as AbilityUpgradeOption);
        }
    }

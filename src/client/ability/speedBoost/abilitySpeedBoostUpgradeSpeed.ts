...
export function addAbilitySpeedBoostUpgradeSpeed() {
    ABILITY_SPEED_BOOST_UPGRADE_FUNCTIONS[ABILITY_SPEED_BOOST_UPGARDE_SPEED] = {
        getAbilityUpgradeUiText: getAbilityUpgradeSpeedUiText,
        getAbilityUpgradeUiTextLong: getAbilityUpgradeSpeedUiTextLong,
        pushAbilityUpgradeOption: pushAbilityUpgradeSpeed,
    }
}

function pushAbilityUpgradeSpeed(ability: Ability, upgradeOptions: AbilityUpgradeOption[]) {
    upgradeOptions.push({
        name: ABILITY_SPEED_BOOST_UPGARDE_SPEED, probabilityFactor: 1, upgrade: (a: Ability) => {
